           ...
           $output .= '<div class="tc-wooslider-item">';
              ...
              $output .='<div class="tc-wps-overlay-wrap">';
                 ...
                 $output .= '<div class="tc-wps-overlay-block">';
                     ...
                     if($tcwps_hsd=='false'){
                     $tcwps_sd=$product->post->post_excerpt;
                     $output .= themescode_limit_text($tcwps_sd,$tcwps_wl);
                     }
                     if( $price_value = $product->get_price_html() ){
...
div.tc-wooslider-item .tc-cart-button a {
  color: <?php echo tc_wooslider_option('cart-button-color', 'tc_whooslider_styling', '#66CC99' ); ?>;
